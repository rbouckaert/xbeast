...
//            
//            Constructor<?> con = xbeast.util.PackageManager.forName(inputEditor).getConstructor(BeautiDoc.class);
//            inputEditor = (InputEditor) con.newInstance(doc);
//            //inputEditor = (InputEditor) xbeast.util.PackageManager.forName(inputEditor).newInstance(doc);
