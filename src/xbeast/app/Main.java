...
public class Main {
    ...
    private final static xbeast.app.util.Version version = new BEASTVersion2();
...
//            }
        ...
        xbeast.core.Runnable beastMCMC;
    }

    public Main(final xbeast.core.Runnable beastMCMC, final BeastConsoleApp consoleApp, final int maxErrorCount) {
...
//        }
        ...
        try {
	        ...
	        if (beastFile.getPath().toLowerCase().endsWith(".json")) {
	        	...
	        	try {
	        		runner = new xbeast.util.XMLParser().parseFile(beastFile);
